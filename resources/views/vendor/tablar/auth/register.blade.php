...
@section('content')
    <div class="container container-tight py-4">
        ...
        <form class="card card-md" action="{{route('register')}}" method="post" autocomplete="off" novalidate>
            @csrf
            <div class="card-body">
                <h2 class="card-title text-center mb-4">CCrear una nueva cuenta</h2>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label class="form-check">
                        ...
                        <span class="form-check-label">Estas de acuerdo <a href="#" tabindex="-1">Terminos y Condiciones</a>.</span>
                    </label>
                </div>
