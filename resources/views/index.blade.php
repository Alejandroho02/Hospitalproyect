...
<div class="container-fluid bg-primary text-white pt-4 pb-5 d-none d-lg-flex">
    <div class="container pb-2">
        <div class="d-flex align-items-center justify-content-between">
            ...
            <a href="index.html" class="h1 text-white mb-0">Clinica<span class="text-dark">Sol☀️</span></a>
            <div class="d-flex">
                <div class="ms-3">
                    @if (Route::has('login'))
                    <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                        @auth
                            <a href="{{ url('/home') }}" class="btn btn-primary">Perfil</a> <!-- Modificado -->
                        @else
                            <a href="{{ route('login') }}" class="btn btn-dark btn-light ">Iniciar sesion</a> <!-- Modificado -->
                        @endif
                    </div>
                @endif
                </div>
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light bg-white py-lg-0 px-lg-3">
            <a href="index.html" class="navbar-brand d-lg-none">
                <h1 class="text-primary m-0">Clínica<span class="text-dark">Sol</span></h1>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <div class="ms-auto d-none d-lg-flex">
                    <a class="btn btn-primary ms-2" href=""><i class="fab fa-facebook-f"></i></a> <!-- Modificado -->
                    <a class="btn btn-primary ms-2" href=""><i class="fab fa-twitter"></i></a> <!-- Modificado -->
                    <a class="btn btn-primary ms-2" href=""><i class="fab fa-linkedin-in"></i></a> <!-- Modificado -->
                    <a class="btn btn-primary ms-2" href=""><i class="fab fa-youtube"></i></a> <!-- Modificado -->
                </div>
            </div>
        </nav>
    </div>
                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-lg-7 text-start">
                                <h1 class="display-1 text-white animated slideInRight mb-3">Consultas de calidad</h1>
                    ...
                    <div class="container">
                        <div class="row justify-content-end">
                            <div class="col-lg-7 text-end">
                                <h1 class="display-1 text-white animated slideInLeft mb-3">Doctortes especializados</h1>
